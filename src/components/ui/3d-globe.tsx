...
const DEFAULT_EARTH_TEXTURE = "/web-design/globe/earth-blue-marble.jpg";
const DEFAULT_BUMP_TEXTURE = "/web-design/globe/earth-topology.png";
...
function Marker({
  ...
  const markerPixelSize = Math.max(
    3,
    Math.round((marker.size ?? defaultSize) * 45),
  );
  ...
  return (
    <group ref={groupRef} visible={isVisible}>
      ...
      <mesh position={surfacePosition} quaternion={lineQuaternion}>
        ...
        <meshBasicMaterial color={hovered ? "#dce5ff" : "#8ca5ff"} />
      </mesh>
      ...
      <group ref={imageGroupRef} position={topPosition}>
        ...
        >
          <div
            className={cn(
              "cursor-pointer overflow-hidden rounded-full bg-[#b7c5ff] shadow-[0_0_14px_rgba(116,145,255,0.9)] transition-transform duration-200",
...
function RotatingGlobe({
  ...
  React.useEffect(
    () => () => {
      configuredEarthTexture.dispose();
      configuredBumpTexture.dispose();
    },
    [configuredBumpTexture, configuredEarthTexture],
  );
