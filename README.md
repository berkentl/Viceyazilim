...
`/yonetim/nfc` içindeki Google işletme araması, sunucu tarafında Google Places API
(New) Text Search kullanır. Yerel geliştirme ve Vercel ortamlarında aşağıdaki gizli
